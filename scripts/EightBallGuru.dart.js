...
$.initButtons = function() {
  $.add$1($.document().query$1('#addButton').get$on().get$click(), new $.initButtons_anon());
  $.add$1($.document().query$1('#chooseButton').get$on().get$click(), new $.initButtons_anon0());
};
...
$.stringReplaceAllUnchecked = function(receiver, from, to) {
  if (from === '')
    ...
    return $.stringReplaceJS(receiver, $.regExpMakeNative($.JSSyntaxRegExp$(from.replace($.regExpMakeNative($.CTC26, true), "\\$&"), false, false), true), to);
};
...
$.actuallyAddItemToList = function(newthing) {
  var newItem = $._ElementFactoryProvider_Element$html($.replaceAll($.query('#template').get$innerHTML(), '%newItem%', newthing));
  $.add$1($.query('#List').get$nodes(), newItem);
};
...
$.chooseItem = function() {
  ...
  var itemList = $.HashMapImplementation$();
  for (var t1 = $.iterator(itemListFromDOM), count = 0; t1.hasNext$0() === true;) {
    itemList.operator$indexSet$2(count, $.index(t1.next$0().get$nodes(), 0).get$text());
    ++count;
  }
  --count;
  itemList.remove$1(count);
  for (var i = 0; i < count; ++i)
    $.print(itemList.operator$index$1(i));
  var selectedItem = itemList.operator$index$1($.Random_Random(null).nextInt$1(count));
  $.query('#List').remove$0();
  $.add$1($.query('#listParent').get$nodes(), $._ElementFactoryProvider_Element$html('<div id="List"></div>'));
  $.actuallyAddItemToList(selectedItem);
  var newItem = $.query('.item');
  newItem.get$classes().remove$1('alert-info');
  $.add$1(newItem.get$classes(), 'alert-success');
};
...
$.addItemToList = function() {
  var box = $.query('#newItemBox');
  var newthing = box.get$value();
  if ($.gtB($.get$length(newthing), 0)) {
...
$._ElementFactoryProvider_Element$html = function(html) {
  var match = $.CTC19.firstMatch$1(html);
  if (!(match == null)) {
    var tag = $.toLowerCase(match.group$1(1));
    var parentTag = $.CTC20.containsKey$1(tag) === true ? $.CTC20.operator$index$1(tag) : 'div';
  } else {
    tag = null;
    parentTag = 'div';
  }
  ...
  if ($.eqB($.get$length(temp.get$elements()), 1))
    ...
    throw $.$$throw($.IllegalArgumentException$('HTML had ' + $.S($.get$length(temp.get$elements())) + ' ' + 'top level elements but 1 expected'));
  element.remove$0();
  return element;
};
...
$.CTC17 = new Isolate.$isolateProperties.ConstantMap(0, {}, Isolate.$isolateProperties.CTC1);
$.CTC28 = '';
...
$.CTC39 = 'thead';
$.CTC40 = 'track';
$.CTC41 = Isolate.makeConstantList(['body', 'head', 'caption', 'td', 'colgroup', 'col', 'tr', 'tbody', 'tfoot', 'thead', 'track']);
$.CTC42 = false;
$.CTC43 = '^\\[name=["\'][^\'"]+[\'"]\\]$';
$.CTC24 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^\\[name=["\'][^\'"]+[\'"]\\]$');
$.CTC13 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC44 = 'frozen class set cannot be modified';
$.CTC14 = new Isolate.$isolateProperties.UnsupportedOperationException('frozen class set cannot be modified');
...
$.CTC46 = 'structured clone of other type';
$.CTC11 = new Isolate.$isolateProperties.NotImplementedException('structured clone of other type');
$.CTC47 = '<(\\w+)';
$.CTC19 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '<(\\w+)');
...
$.CTC50 = '[-[\\]{}()*+?.,\\\\^$|#\\s]';
$.CTC26 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '[-[\\]{}()*+?.,\\\\^$|#\\s]');
...
$.CTC54 = 'Cannot removeLast on immutable List.';
$.CTC3 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot removeLast on immutable List.');
$.CTC55 = 'structured clone of Date';
$.CTC4 = new Isolate.$isolateProperties.NotImplementedException('structured clone of Date');
$.CTC56 = 'html';
$.CTC57 = 'table';
$.CTC58 = 'audio';
$.CTC20 = new Isolate.$isolateProperties.ConstantMap(11, {'body': 'html', 'head': 'html', 'caption': 'table', 'td': 'tr', 'colgroup': 'table', 'col': 'colgroup', 'tr': 'tbody', 'tbody': 'table', 'tfoot': 'table', 'thead': 'table', 'track': 'audio'}, Isolate.$isolateProperties.CTC41);
$.CTC23 = new Isolate.$isolateProperties._Random();
$.CTC59 = '^[*a-zA-Z0-9]+$';
$.CTC25 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^[*a-zA-Z0-9]+$');
$.CTC60 = 'structured clone of ArrayBuffer';
...
$.CTC61 = 'structured clone of Blob';
...
//@ sourceMappingURL=EightBallGuru.dart.js.map